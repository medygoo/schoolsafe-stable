...
begin;
create schema if not exists devicehub authorization schoolsafe_owner;
set local role schoolsafe_owner;

-- ============================================================================
-- 0. SCHÉMA devicehub
-- ============================================================================
-- The bootstrap administrator created this schema before SET ROLE.
revoke all on schema devicehub from public, schoolsafe_api, schoolsafe_auth;

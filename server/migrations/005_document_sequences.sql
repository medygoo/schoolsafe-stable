-- SchoolSafe LOT 5: Document Sequences Table
...
CREATE INDEX IF NOT EXISTS idx_doc_sequences_type ON document_sequences(type_code);
...
DROP TRIGGER IF EXISTS trg_update_document_sequences_updated_at ON document_sequences;
